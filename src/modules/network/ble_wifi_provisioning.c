...
void ble_wifi_provisiong_task(void)
{
	int rc;
	...
	LOG_INF("BLE Wi-Fi provisioning thread started!");
	...
	LOG_INF("BLE Wi-Fi provisioning thread init finished");
}

K_THREAD_DEFINE(ble_wifi_provisiong_task_id,
		CONFIG_MQTT_SAMPLE_TRANSPORT_THREAD_STACK_SIZE,
		ble_wifi_provisiong_task, NULL, NULL, NULL, 3, 0, 0);